...
> **STATUS: COMPLETE** (2026-07-04) — all 22 tasks implemented and reviewed on branch `impl-plan-1` (commits `3bdb966..38426f4`, hashes as of the 2026-07-05 history rewrite); final whole-branch review clean after one consolidated fix wave. Deferred minors and post-plan items: `.sdd/progress.md` and ARCH §12.
